  ...
  <div id="acerca-de" class="grid md:grid-cols-4 gap-4 md:p-4 xs: my-25 md:my-40">
    ...
    <div class="md:col-start-3 md:row-start-3 md:col-span-1 ">
      ...
      <p class="text-left text-md/6">
        ...
        calidad que mejoren la vida de las personas y las empresas.
        Superar los límites de la conectividad, llevando la tecnología a nuevas alturas a través de la inversión en
        infraestructura de red de vanguardia y el desarrollo de soluciones de comunicación avanzadas.
        Visualizarnos como una empresa impulsada por la excelencia, centrada en el cliente y comprometida con la
    ...
    <div class="md:col-start-2 md:row-start-3 md:col-span-1">
      ...
      <p class="text-left text-md/6">
        ...
        eficientes y soluciones integrales adaptadas a las necesidades cambiantes del mercado.
        ser el facilitador de la transformación digital, capacitando a las personas para que se conecten, crezcan y
        prosperen en un mundo cada vez más interconectado.
        Trabajar incansablemente para superar las expectativas de nuestros clientes y marcar la diferencia.
      </p>
    </div>
  </div>
</template>